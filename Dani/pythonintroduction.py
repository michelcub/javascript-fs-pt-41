...
while counter < 10:
    ...
    if counter % 2 == 0:
        continue  ####SALTA
    if counter == 5:
        break  ####HACE BREAK AL LOOP
    print(counter)


###pass es un placeholder para momentos en los que tengamos
### que salir de una función no terminada


# Lo más parecido a un ternario:
example = False
message = "Es verdad" if example else "Es mentira"
